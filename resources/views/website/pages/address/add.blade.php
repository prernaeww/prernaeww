...
@section('content')
    ...
    <section class="account-page my-5 pb-lg-5">
        <div class="container">
            ...
            <h3 class="t-blue mb-4 pb-3 border-bottom">Add Address</h3>
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('add_address') }}" method="post" id="form">
                        @csrf
                        <div class="bg-white border-r10 h-100">
                            <div class="col-xl-8 col-lg-10 mx-auto px-0 mt-5 pb-md-5">
                                ...
                                <input type="hidden" id="administrative_area_level_2" name="zipcode" required
                                ...
                                <input type="hidden" id="administrative_area_level_1" name="state" required
                                    data-parsley-errors-container="#google-address-error"
                                    data-parsley-errors-message="Please select the proper street address from google suggestion.">
                                <input type="hidden" id="zipcode" class="zipcode" name="zipcode" required
                                    data-parsley-errors-container="#google-address-error"
                                    data-parsley-errors-message="Please select the proper street address from google suggestion.">
                                <input type="hidden" id="city" class="city" name="city" required
                                    data-parsley-errors-container="#google-address-error"
                                    data-parsley-errors-message="Please select the proper street address from google suggestion.">
                                <input type="hidden" id="longitude" class="longitude" name="longitude" required
                                    data-parsley-errors-container="#google-address-error"
                                    data-parsley-errors-message="Please select the proper street address from google suggestion.">
                                <input type="hidden" id="latitude" class="latitude" name="latitude" required
                                    data-parsley-errors-container="#google-address-error"
                                    data-parsley-errors-message="Please select the proper street address from google suggestion.">
                                ...
                                <div class="form-group my-4 pt-2 mx-md-3 border-bottom-login">
                                    <label class="font-18 mb-0 w-100 t-grey">Your location
                                        <div class="d-flex">
                                            <input type="text" name="address" value="" id="autocomplete"
                                                onFocus="geolocate()" placeholder="ABC Screen,NY,US - 388-345"
                                                class="sign-in-input-field" required
                                ...
                                <div class="mx-md-3">
                                    ...
                                    <ul class="sign-up-as d-flex align-items-center flex-wrap">
                                        <li class="mr-2 mr-sm-4 address_type active" data-value='3'><a href="#"
                                                title="">Home</a></li>
                                        <li class="mr-2 mr-sm-4 address_type" data-value='1'><a href="#" title="">Office</a>
                                        </li>
                                        <li class="mr-2 mr-sm-4 address_type" data-value='4'><a href="#" title="">Other</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
