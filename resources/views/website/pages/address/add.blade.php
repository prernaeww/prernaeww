                ...
                @csrf
    				<div class="bg-white border-r10 h-100">
    					<div class="col-xl-8 col-lg-10 mx-auto px-0 mt-5 pb-md-5">
                            ...
                            <div class="form-group my-4 pt-2 mx-md-3 border-bottom-login">
                                <label class="font-18 mb-0 w-100 t-grey">Your location
                                    <div class="d-flex">
                                        <input type="text" name="address" value="" id="autocomplete" onFocus="geolocate()" placeholder="ABC Screen,NY,US - 388-345" class="sign-in-input-field" required data-parsley-errors-container="#address-error" autocomplete="off">
                            ...
                            <div class="mx-md-3">
                                ...
                                <ul class="sign-up-as d-flex align-items-center flex-wrap">
                                    <li class="mr-2 mr-sm-4 address_type active" data-value='3'><a href="#" title="">Home</a></li>
                                    <li class="mr-2 mr-sm-4 address_type" data-value='1'><a href="#" title="">Office</a></li>
                                    <li class="mr-2 mr-sm-4 address_type" data-value='4'><a href="#" title="">Other</a></li>
                                </ul>
                            </div>
                        </div>
    					...
    					<!-- <div class="mt-3 text-center">
    						<a href="#" data-dismiss="modal" data-toggle="modal" data-target="#add-address-modal" title="" class="btn-blue2 mt-2">Add Address</a>
    					</div>     --> 
                    </div>
                </form>               
				</div>
