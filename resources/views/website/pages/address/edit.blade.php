                 ...
                 @method('PUT') 
    				<div class="bg-white border-r10 h-100">
    					<div class="col-xl-8 col-lg-10 mx-auto px-0 mt-5 pb-md-5">
                            ...
                            <input type="hidden" id="administrative_area_level_2" class="zipcode" name="zipcode" value="{{ $address->zipcode }}">
                            <input type="hidden" id="administrative_area_level_1" class="state" name="state" value="{{ $address->state }}">
                            <input type="hidden" id="zipcode" class="zipcode" class="zipcode" name="zipcode" value="{{ $address->zipcode }}">
                            <input type="hidden" id="city" class="city" class="city" name="city" value="{{ $address->city }}">
                            <input type="hidden" id="longitude" class="longitude" class="longitude" name="longitude" value="{{ $address->log }}">
                            <input type="hidden" id="latitude" class="latitude" class="latitude" name="latitude" value="{{ $address->lat }}">
                            <input type="hidden" id="address_id" class="address_id" class="address_id" name="address_id" value="{{ $address->id }}">
                            <input type="hidden" id="user_id" class="user_id" class="user_id" name="user_id" value="{{ $address->user_id }}">

                            <div class="form-group my-4 pt-2 mx-md-3 border-bottom-login">
                                <label class="font-18 mb-0 w-100 t-grey">Your location
                                    <div class="d-flex">
                                        <input type="text" name="address" id="autocomplete" onFocus="geolocate()" placeholder="ABC Screen,NY,US - 388-345" class="sign-in-input-field complete_address" required data-parsley-errors-container="#address-error" autocomplete="off" value="{{ $address->complete_address }}">
                            ...
                            <div class="mx-md-3">
                                ...
                                <ul class="sign-up-as d-flex align-items-center flex-wrap">
                                    <li class="mr-2 mr-sm-4 address_type @if( $address->address_type == '3') active @endif " data-value='3'><a href="#" title="">Home</a></li>
                                    <li class="mr-2 mr-sm-4 address_type @if( $address->address_type == '1') active @endif " data-value='1'><a href="#" title="">Office</a></li>
                                    <li class="mr-2 mr-sm-4 address_type @if( $address->address_type == '4') active @endif " data-value='4'><a href="#" title="">Other</a></li>
                                </ul>
                            </div>
                        </div>
