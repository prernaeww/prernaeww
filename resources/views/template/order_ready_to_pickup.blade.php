                        ...
                        <tr>
                            <td class="o_bg-white o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="o_sans o_text o_text-secondary o_b-primary o_px o_py o_br-max"
                                                ...
                                                <img src="{{ URL('images/check-48-primary.png') }}" width="48"
                                                    height="48" alt=""
                                ...
                                <h2 class="o_heading o_text-dark o_mb-xxs"
                                    style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;text-align: center !important;">
                                    Order ready for pickup</h2>
                                <p style="margin-top: 0px;margin-bottom: 0px;text-align: center !important;">
                                    {{ $message }}</p>
                            </td>
                        </tr>
                    </tbody>
