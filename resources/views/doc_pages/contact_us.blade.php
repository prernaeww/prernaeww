			...
			<div class="row mx-2">
				<div class="col-md-12">
					<div class="text-center pb-lg-5">
						<h1 class="t-blue font-weight-bold border-bottom1 pb-3 mb-5 d-inline-block"> Contact Us</h1>
					</div>					
					<!-- <b><p>What is Lorem Ipsum?</p></b> -->
					<p>Dalcom Consulting Inc.
						8D Oak Branch Dr. 
						Greensboro, NC 27407s</p>

					<p>1-877-768-6762</p>

					<p>sales@dalcom.com</p>
