                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td colspan="5">{{date('m-d-Y', strtotime($banner->start_date))}}</td>
                            </tr>
                            <tr>
                                <th class="text-nowrap" scope="row">End Date</th>
                                <td colspan="5">{{date('m-d-Y', strtotime($banner->end_date))}}</td>
                            </tr>
                            <tr>
                                <th class="text-nowrap" scope="row">Image</th>
                                <td colspan="5" >
                                    <img style="height: 100px;width: auto;" src="{{$banner->image}}">
                                </td>
                            </tr>
                            </tbody>
                        </table>
