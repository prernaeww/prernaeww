...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-xl-6">
			<div class="card">
				<div class="card-body" >
                <form action="{{ route('board.product.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="kitchen_id" parsley-trigger="change" value="{{$product->kitchen_id}}" required placeholder="Enter Kitchen Id" class="form-control" id="kitchen_id">
                                @error('kitchen_id')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            @endphp
                                <img class="border rounded p-0"  src="{{env('AWS_S3_URL').$product->image}}" onerror="this.src='{{$default}}'" alt="your image" style="height: 130px;width: 130px; object-fit: cover;" id="blah1"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group text-right m-b-0">
                        ...
                        <a href="{{ route('board.product.index') }}" class="btn btn-secondary waves-effect m-l-5">Cancel</a>
