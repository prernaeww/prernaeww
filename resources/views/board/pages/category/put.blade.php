...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-xl-6">
			<div class="card">
				<div class="card-body" >
                <form action="{{ route('board.category.update',$category->id) }}" method="POST"  enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="kitchen_id" parsley-trigger="change" value="{{$category->kitchen_id}}" required placeholder="Enter Kitchen Id" class="form-control" id="kitchen_id">
                                @error('kitchen_id')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
