                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-6 text-right">
                                            ...
                                            <address>
                                                <a href="{{route('board.store.show',$order->store_id)}}">{{$order->store_name}}</a> <br>
                                                <a href="tel:{{$order->store->phone_formatted}}">Call {{$order->store->phone_formatted}}</a><br>
                                                {{$order->store_address}}
                                            </address>
                                        </div> <!-- end col -->
                                    </div> 
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="clearfix pt-5">
                                                ...
                                                @else
                                                <strong class="text-muted d-block"></strong>
