...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    {{ Breadcrumbs::render('Board-order')}}
                </div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body" >
                    <form class="form-inline mb-2" method="post" action="{{route('board.orders.index')}}" id="filter-form">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect waves-light" id="send_notifi" data-user-id="" data-order-id="">Send </button>
            </div>
        </form>
            </div>
        </div>
