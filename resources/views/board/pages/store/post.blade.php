                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" parsley-trigger="change" value="{{old('first_name')}}" required placeholder="Enter first name" class="form-control" id="first_name">
                                @error('first_name')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="last_name" parsley-trigger="change" value="{{old('last_name')}}" required placeholder="Enter last name" class="form-control" id="last_name">
                                @error('last_name')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                         ...
                         <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" parsley-trigger="change" value="{{old('email')}}" required placeholder="Enter email" class="form-control" id="email">
                                @error('email')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="start_time" parsley-trigger="change" value="{{old('start_time')}}" required class="form-control" id="start_time">
                                @error('start_time')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" name="end_time" parsley-trigger="change" value="{{old('end_time')}}" required class="form-control" id="end_time">
                                @error('end_time')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" parsley-trigger="change" value="{{old('address')}}" required placeholder="Enter Address" class="form-control" id="searchTextField">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="zipcode" parsley-trigger="change" value="{{old('zipcode')}}" required placeholder="Enter Zipcode" class="form-control" id="email">
                                @error('zipcode')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="latitude" parsley-trigger="change" value="{{old('latitude')}}" required placeholder="Enter Latitude" class="form-control" id="country">
                                @error('latitude')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="longitude" parsley-trigger="change" value="{{old('longitude')}}" required placeholder="Enter longitude" class="form-control" id="longitude">
                                @error('longitude')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group ">
                                ...
                                <div class="row ml-2 d-flex flex-row">
                                    ...
                                    <div class="pl-2 pr-3 custom-control custom-checkbox">
                                            <input type="checkbox" required  data-parsley-errors-container="#service" name="delivery_type[]"  value="2" class="custom-control-input" id="customCheck2">
                     ...
                     <div class="row">
                        ...
                        <div class="col-6">
                             <div class="form-group">
                               ...
                               <input type="text" name="phone" parsley-trigger="change" value="{{old('phone')}}"  required  class="form-control"  id="phone"  minlength="10">
                                @error('phone')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
