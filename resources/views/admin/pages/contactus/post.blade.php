                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" data-parsley-errors-container="#parent_error" value="{{old('user_id')}}" name="user_id" id="user_id" data-placeholder="Select Board" required>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group ">
                                ...
                                <input type="text"  id="datepicker" name="start_date" parsley-trigger="change" value="{{old('start_date')}}" required placeholder="Enter Start Date" class="form-control depature_datepicker" id="name" autocomplete="off">
                                @error('start_date')
                                    <div class="error">{{ $message }}</div>
                                @enderror        
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group ">
                                ...
                                <input type="text" name="end_date" parsley-trigger="change" value="{{old('end_date')}}" required placeholder="Enter End Date" class="form-control depature_datepicker" id="name" autocomplete="off">
                                @error('end_date')
                                    <div class="error">{{ $message }}</div>
                                @enderror        
                            </div>
