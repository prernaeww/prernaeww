                        ...
                        <div class="col-12">
                         ...
                         <div class="col-lg-12">
                            <div class="form-group ">
                                ...
                                <input type="text"  id="datepicker" name="start_date" parsley-trigger="change" value="{{date('d-m-Y', strtotime($banner->start_date))}}" required placeholder="Enter Start Date" class="form-control depature_datepicker" id="name">
                                @error('start_date')
                                    <div class="error">{{ $message }}</div>
                                @enderror        
                            </div>
                         ...
                         <div class="col-lg-12">
                            <div class="form-group ">
                                ...
                                <input type="text" name="end_date" parsley-trigger="change"  value="{{date('d-m-Y', strtotime($banner->end_date))}}" required placeholder="Enter End Date" class="form-control depature_datepicker" id="name">
                                @error('end_date')
                                    <div class="error">{{$message}}</div>
                                @enderror        
                            </div>
