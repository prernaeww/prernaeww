                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" parsley-trigger="change" value="{{$user->first_name}}" required placeholder="Enter Store Name" class="form-control" id="first_name">
                                @error('first_name')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_time" parsley-trigger="change" 
                                value="{{$user->start_time}}" required class="form-control flatpickr-input" id="basic-timepicker" autocomplete="off" style="background-color:white;">
                                @error('start_time')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="end_time" parsley-trigger="change" value="{{$user->end_time}}" required class="form-control flatpickr-input " id="basic-timepicker" autocomplete="off" style="background-color:white;">
                                @error('end_time')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="autocomplete" onFocus="geolocate()" name="address" parsley-trigger="change" value="{{$user->address}}" required placeholder="Enter Address" class="form-control" >
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="zipcode"  id="zipcode" parsley-trigger="change" value="{{$user->zipcode}}" required placeholder="Enter Zipcode" class="form-control zipcode">
                                @error('zipcode')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                          ...
                          <div class="col-6">
                            <div class="form-group" id="latitudeArea">
                                ...
                                <input type="text" name="latitude" id="latitude" parsley-trigger="change" value="{{$user->latitude}}" required placeholder="Enter Latitude" class="form-control latitude" >
                                @error('latitude')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                          ...
                          <div class="col-6">
                            <div class="form-group" id="longtitudeArea">
                                ...
                                <input type="text" name="longitude" id="longitude" parsley-trigger="change" value="{{$user->longitude}}" required placeholder="Enter Longitude" class="form-control longitude">
                                @error('longitude')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBjt0uhpWIVD3GSOCeI01LOoWsGJJsi7co&libraries=places&callback=initAutocomplete" async defer></script>
<script>
