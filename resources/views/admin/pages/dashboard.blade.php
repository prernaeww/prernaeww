        ...
        <div class="col-md-6 col-xl-3">
            <div class="widget-rounded-circle card-box">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="text-right">
                            <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$board}}</span></h3>
                            <p class="text-muted mb-1 text-truncate">Total Boards</p>
                        </div>
                    </div>
                </div> <!-- end row-->
            </div> <!-- end widget-rounded-circle-->
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="avatar-lg rounded-circle border-info border">
                            <i class="fas fa-store font-22 avatar-title text-info"></i>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="text-right">
                                        ...
                                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>{{$data->product->retail_discount}}%</td>
                                                   <td>{{$data->product->business_discount}}%</td>
                                                   <td>{{$data->total_product_id}}</td>
                                                   <td><a href="{{route('admin.product.edit',$data->id)}}">View</a></td>
                                                   @php
                                                   $number++
                                                   @endphp
                                               </tr>
