                ...
                @method('POST')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="item_code" parsley-trigger="change" value="{{old('item_code')}}" required placeholder="Enter Item Code" class="form-control" id="item_code">
                                @error('item_code')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="quantity" parsley-trigger="change" value="{{old('quantity')}}" required placeholder="Enter Quantity Ex. 750" class="form-control quantity" id="quantity" data-parsley-errors-container="#quantity_error">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="age" parsley-trigger="change" value="{{old('age')}}" placeholder="Enter Age" class="form-control age" id="age" data-parsley-errors-container="#age_error">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="proof" parsley-trigger="change" value="{{old('proof')}}" placeholder="Enter Proof" class="form-control perc" id="proof" data-parsley-errors-container="#proof_error">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="previous_price_retail" parsley-trigger="change" value="{{old('previous_price_retail')}}" required placeholder="Enter Price" class="form-control price-touchspin" id="previous_price_retail" data-parsley-errors-container="#previous_price_retail_error" min="0">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="current_price_retail" parsley-trigger="change" value="{{old('current_price_retail')}}" required placeholder="Enter Price" class="form-control price-touchspin" id="current_price_retail" data-parsley-errors-container="#current_price_retail_error" min="0">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{old('retail_discount')}}" placeholder="0" class="form-control" disabled id="retail_discount">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="previous_price_business" parsley-trigger="change" value="{{old('previous_price_business')}}" required placeholder="Enter Price" class="form-control price-touchspin" id="previous_price_business" data-parsley-errors-container="#previous_price_business_error" min="0">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="current_price_business" parsley-trigger="change" value="{{old('current_price_business')}}" required placeholder="Enter Price" class="form-control price-touchspin" id="current_price_business" data-parsley-errors-container="#current_price_business_error" min="0">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{old('business_discount')}}" placeholder="0" class="form-control" disabled id="business_discount">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            @endphp
                                <img class="p-0"  src="" onerror="this.src='{{$default}}'" alt="your image" style="height: 130px;width: 130px; object-fit: scale-down;" id="blah"/>
                            </div>
                        </div>
                    </div>
