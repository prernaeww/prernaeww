                    ...
                    <div class="card bg-pattern">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                ...
                                <p class="text-muted mb-4 mt-3">Enter your email address and password to access Store panel.</p>
                            </div>
                            ...
                            <form action="{{ route('store.login') }}" method="post">
                                ...
                                <a href="{{ route('store.forgot') }}" class="text-dark p-t-1"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>
