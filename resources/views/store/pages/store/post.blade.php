                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" value="09:00" name="start_time" parsley-trigger="change" value="{{old('start_time')}}" required class="form-control" id="start_time" autocomplete="off">
                                @error('start_time')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="time" value="20:00" name="end_time" parsley-trigger="change" value="{{old('end_time')}}" required class="form-control" id="end_time" autocomplete="off">
                                @error('end_time')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-6">
                             <div class="form-group">
                               ...
                               <input type="text" name="phone" parsley-trigger="change" value="{{old('phone')}}"  required  class="form-control" placeholder="Enter Phone"  id="phone"  minlength="10">
                                @error('phone')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
