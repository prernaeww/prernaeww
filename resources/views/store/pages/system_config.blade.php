                        ...
                        <div class="portlet-body">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{CommonHelper::ConfigGet('phone')}}" class="form-control" name="phone">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label">{{ __('Twitter')}}</label>
                                    <input type="text" value="{{CommonHelper::ConfigGet('twitter')}}" class="form-control" name="twitter">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label">{{ __('Instagram')}}</label>
                                    <input type="text" value="{{CommonHelper::ConfigGet('instagram')}}" class="form-control" name="instagram">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label">{{ __('Tax') }}</label>
                                    <input type="number" value="{{CommonHelper::ConfigGet('tax')}}" class="form-control" name="tax">
                                </div>
                                <div class="form-group">
