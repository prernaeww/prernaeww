    ...
    <div class="row">
        <div class="col-lg-4 col-xl-4">
            <div class="card-box text-center">
                <img src="{{env('AWS_S3_URL').$user['profile_picture']}}" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">

                <h4 class="mb-0">{{$user['first_name']}}</h4>
                <p class="text-muted">{{$user['email']}}</p>

                <div class="text-left mt-3">
                    <p class="text-muted mb-2 font-13"><strong>Store Name :</strong> <span class="ml-2">{{$user['first_name']}}</span></p>
        ...
        <div class="col-lg-8 col-xl-8">
            <div class="card-box">
                ...
                <form action="{{ route('store.profile.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-xl-8">
            <div class="card-box">
                ...
                <form action="{{ route('store.change.password',$user->id) }}" method="POST">
                    @csrf
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <!-- <textarea class="form-control" id="product-summary" rows="1" placeholder="Please enter password" name="correct_answer">{{ old('correct_answer') }}</textarea> -->
                        <input type="password" name="new_password" minlength="8" id="new_password" required  class="form-control">
                        @error('new_password')
                        <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <!-- <textarea class="form-control" id="product-summary" rows="1" placeholder="Please enter password" name="correct_answer">{{ old('correct_answer') }}</textarea> -->
                        <input type="password" name="confirm_new_password" minlength="8" id="confirm_new_password" data-parsley-equalto="#new_password" required class="form-control">
