        ...
        <div class="col-lg-4 col-xl-4">
            <div class="card-box text-center">
                ...
                <div class="text-left mt-3">
                    ...
                    @endif
                    @if($user_group['group_id'] == '3' || $user_group['group_id'] == '4' || $user_group['group_id'] == '5' || $user_group['group_id'] == '6')
                    <p class="text-muted mb-2 font-13"><strong>Gender :</strong> <span class="ml-2">{{$user['gender'] == '1' ? 'Male' : 'Female'}}</span></p>
                    @endif
                    @if($user_group['group_id'] == '4' || $user_group['group_id'] == '5' || $user_group['group_id'] == '6')
                    <p class="text-muted mb-2 font-13"><strong>DOB :</strong> <span class="ml-2">{{ $user['dob'] }}</span></p>
                    @endif
                    @if($user_group['group_id'] == '5')
