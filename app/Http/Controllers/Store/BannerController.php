       ...
       else
       {
           $columns = [
            //    ['data' => 'sequence', 'name' => 'sequence','title' => __("Sequence")],
               ...
               ['data' => 'user_name.first_name','name' => 'user_data.full_name', 'title' => __("Board Name"),'searchable'=>false],
               ['data' => 'start_date','name' => 'start_date', 'title' => __("Start Date"),'searchable'=>false],
               ['data' => 'end_date','name' => 'end_date', 'title' => __("End Date"),'searchable'=>false],
