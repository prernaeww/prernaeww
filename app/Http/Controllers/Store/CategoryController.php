    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax())
       {
            ...
            ->editColumn('image', function ($row) {
                return '<img class="border rounded p-0" src="'.$row['image'].'" onerror="this.src=/images/default.png" alt="your image" style="height: 70px;width: 70px; object-fit: cover;" id="blah1"/>';
            })
